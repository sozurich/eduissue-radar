...
# 3. Naver news crawl remains same
...
def local_summarize(text, max_sentences=5):
    ...
    for i, sent in enumerate(sents):
        w = re.findall(r'[\w가-힣]+', sent.lower())
...
st.markdown('교과서 민원 메시지 분석 + 개선된 로컬 요약')
...
if uploaded:
    ...
    with tab2:
        ...
        for topic in ['교과서','AI 디지털교과서','비상교육','천재교육','미래엔']:
